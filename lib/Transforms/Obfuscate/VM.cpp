...
Function *Virtualize::CreateAdd(FunctionType *funcTy, Module &M){
  Function *f = Function::Create(funcTy, GlobalValue::InternalLinkage, "__CHAT_06_Add", M);
...
Function *Virtualize::CreateSub(FunctionType *funcTy, Module &M){
  ...
  Function *f = Function::Create(funcTy, GlobalValue::InternalLinkage, "__CHAT_06_Sub", M);
  Function::arg_iterator itArgs = f->arg_begin(); Value *x = itArgs; Value *y = ++itArgs;
  BasicBlock *entry = BasicBlock::Create(M.getContext(), "entry", f);
  IRBuilder<> Builder(entry);
...
Function *Virtualize::CreateShl(FunctionType *funcTy, Module &M){
  Function *f = Function::Create(funcTy, GlobalValue::InternalLinkage, "__CHAT_06_Shl", M);
  Function::arg_iterator itArgs = f->arg_begin(); Value *x = itArgs; Value *y = ++itArgs;
  BasicBlock *entry = BasicBlock::Create(M.getContext(), "entry", f);
...
Function *Virtualize::CreateAShr(FunctionType *funcTy, Module &M){
  Function *f = Function::Create(funcTy, GlobalValue::InternalLinkage, "__CHAT_06_AShr", M);
  Function::arg_iterator itArgs = f->arg_begin(); Value *x = itArgs; Value *y = ++itArgs;
  BasicBlock *entry = BasicBlock::Create(M.getContext(), "entry", f);
...
Function *Virtualize::CreateLShr(FunctionType *funcTy, Module &M){
  Function *f = Function::Create(funcTy, GlobalValue::InternalLinkage, "__CHAT_06_LShr", M);
  Function::arg_iterator itArgs = f->arg_begin(); Value *x = itArgs; Value *y = ++itArgs;
  BasicBlock *entry = BasicBlock::Create(M.getContext(), "entry", f);
...
Function *Virtualize::CreateAnd(FunctionType *funcTy, Module &M){
  Function *f = Function::Create(funcTy, GlobalValue::InternalLinkage, "__CHAT_06_And", M);
  Function::arg_iterator itArgs = f->arg_begin(); Value *x = itArgs; Value *y = ++itArgs;
  BasicBlock *entry = BasicBlock::Create(M.getContext(), "entry", f);
  IRBuilder<> Builder(entry);
...
Function *Virtualize::CreateOr(FunctionType *funcTy, Module &M){
  Function *f = Function::Create(funcTy, GlobalValue::InternalLinkage, "__CHAT_06_Or", M);
  Function::arg_iterator itArgs = f->arg_begin(); Value *x = itArgs; Value *y = ++itArgs;
  BasicBlock *entry = BasicBlock::Create(M.getContext(), "entry", f);
  IRBuilder<> Builder(entry);
...
Function *Virtualize::CreateXor(FunctionType *funcTy, Module &M){
  ...
  Function *f = Function::Create(funcTy, GlobalValue::InternalLinkage, "__CHAT_06_Xor", M);
  Function::arg_iterator itArgs = f->arg_begin(); Value *x = itArgs; Value *y = ++itArgs;
  BasicBlock *entry = BasicBlock::Create(M.getContext(), "entry", f);
  IRBuilder<> Builder(entry);
